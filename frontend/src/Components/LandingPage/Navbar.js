    ...
    <nav className="bg-white border-gray-200 py-3 dark:bg-gray-900 shadow-sm">
      <div className="flex flex-wrap items-center justify-between max-w-screen-xl px-1 mx-auto">
        ...
        <div className="space-x-2">
          {!isAuthenticated ? (
            <button onClick={login} disabled={isLoggingIn} className="hidden lg:inline-block text-black font-medium py-2 px-4 border border-gray-300 rounded-md dark:bg-gray-800 hover:bg-purple-700 hover:text-white  dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-500">
