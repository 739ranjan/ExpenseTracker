    ...
    return (
        ...
        <div className={`${styles.landing_bg}`}>
            <div className={`flex flex-col justify-center items-center lg:w-[70%] md:w-[70%] m-auto`}>
                ...
                <Link className=" lg:inline-block text-white font-bold bg-purple-700 hover:bg-purple-100 hover:text-purple-800 focus:ring-4 focus:ring-purple-300 rounded-lg text-md px-5 py-2 dark:bg-purple-600 dark:hover:bg-purple-700 dark:focus:ring-purple-800"> Try Now </Link>
                </button>
